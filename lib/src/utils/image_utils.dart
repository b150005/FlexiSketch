...
class ImageUtils {
  ...
  /// Base64エンコード処理をバックグラウンドで実行する
  static Future<String> _encodeToBase64(Uint8List bytes) {
    return compute((Uint8List bytes) => base64Encode(bytes), bytes);
  }
  ...
  static Future<String> encodeImageToBase64(
    ...
    final encodedImage = await _encodeToBase64(bytes);
